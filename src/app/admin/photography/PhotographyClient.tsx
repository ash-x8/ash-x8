...
export default function PhotographyClient({ initialItems }: { initialItems: PhotoItem[] }) {
  ...
  const categories = ["Portrait", "Landscape", "Event", "Editorial", "Commercial", "Nature"];
    ...
    <div className="min-h-screen bg-[#090a0f] text-slate-100 flex">
      ...
      <main className="flex-1 lg:pl-64 p-6 sm:p-10 space-y-8">
        <div className="flex items-center justify-between pb-6 border-b border-[#222738]">
          <div>
            <h1 className="text-3xl font-extrabold text-white tracking-tight">Photography Manager</h1>
            <p className="text-xs text-slate-400 font-mono mt-1">
              Upload, organize, and manage photographic portfolio assets for Kushan A Wickramasinghe.
            </p>
          </div>
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="space-y-1">
                ...
                {item.cameraInfo && <p className="text-slate-400 text-xs font-mono">{item.cameraInfo}</p>}
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      value={editing.category || "Portrait"}
                ...
                <div>
                  <label className="text-xs font-mono uppercase text-slate-400 font-semibold">Camera / EXIF Info</label>
                  <input
                    type="text"
                    value={editing.cameraInfo || ""}
                    onChange={(e) => setEditing({ ...editing, cameraInfo: e.target.value })}
